...
const beforeAfterProjects = [
    {
        ...
        title: "Noida Kitchen Remodel",
        description: "From a cramped and dated kitchen to a bright, open-concept culinary hub in Noida."
    },
    {
        ...
        title: "Living Room Transformation in Noida",
...
const whyChooseUs = [
    ...
    },
    {
        ...
        title: "1000+ Happy Clients in Noida",
        description: "Our 1000+ happy customers in the Noida region are a testament to our best-in-class interior designing services. We always aim to deliver high-quality service within your budget.",
    },
    {
        icon: <DollarSign className="h-8 w-8 text-primary" />,
        title: "Economic Cost for Noida Homes",
        description: "We offer an affordable wide range of interior designing services for your dream home in Noida, with no compromise on material quality to ensure durability.",
    },
     {
    ...
    },
    {
        ...
        description: "We believe that transparency is the core key in excellent customer service. So, we don't have any hidden charges. What you see is what you pay for your Noida interior project.",
    },
    {
        icon: <Briefcase className="h-8 w-8 text-primary" />,
        title: "Expert Interior Designers in Noida",
        description: "Our experienced designers have decades of experience in interior designing in Noida. Hand over everything to us and relax, we will take care of everything.",
    },
];
...
const services = [
  {
    value: "residential",
    title: "Residential Design in Noida",
    description: "We at Naims Interior, provide complete residential interior designing services in Noida including:",
    items: [
  ...
  },
  {
    ...
    title: "Noida Kitchen & Bathroom Interior",
    description: "We offer complete Kitchen and Bathroom interior services for your dream home in Noida, including:",
    items: [
  ...
  {
    value: "renovation",
    title: "Home Renovation in Noida",
    description: "We undertake complete home renovations and makeovers across the Noida area, including:",
    items: [
      "Full Home Makeover",
...
const faqs = [
    {
        question: "What is the first step to starting a project with Naims Interior in Noida?",
        answer: "The first step is to schedule a free consultation with one of our expert designers. You can do this by filling out the contact form on our website or by calling our Noida office directly. During this meeting, we'll discuss your vision, needs, and budget to see how we can best help you."
    },
    {
        question: "How long does a typical interior design project take in Noida?",
        answer: "The timeline for a project can vary greatly depending on the scope. A single room design in Noida might take 4-6 weeks, while a full home renovation could take several months. We will provide a detailed project timeline after our initial consultation and design approval."
    },
    {
        question: "Do you work with my existing furniture and decor?",
        answer: "Absolutely! We believe in creating spaces that reflect you. We can certainly incorporate your existing beloved pieces into the new design. We can also help you decide what to keep, what to reupholster, and what to replace to achieve your desired look for your Noida home."
    },
    {
        question: "What is your fee structure for projects in Noida?",
      ...
      <main className="flex-1">
        ...
        <section className="relative h-[80vh] w-full">
          <Image
            ...
            alt="Beautifully designed living room in Noida"
            fill
            className="z-0 object-cover"
            data-ai-hint="living room Noida"
            priority
          />
          <div className="relative z-10 flex h-full flex-col items-center justify-center bg-black/50 text-center text-white">
            <h1 className="font-headline text-4xl md:text-6xl lg:text-7xl">
              Best Interior Design in Noida
            </h1>
            <p className="mt-4 max-w-2xl text-lg md:text-xl">
              Creating beautiful, functional interiors for homes and offices in Noida.
            </p>
            <div className="mt-8">
            ...
            <div className="grid gap-12 md:grid-cols-2 lg:gap-20 items-center">
              <div>
                <h2 className="font-headline text-3xl md:text-4xl">
                  Your Trusted Interior Designer in Noida
                </h2>
              ...
              <div className="relative h-80 w-full rounded-lg shadow-xl">
                 <Image
                    ...
                    alt="Design team collaborating on a Noida project"
                    fill
        ...
        <section className="bg-muted py-16 md:py-24">
            <div className="container mx-auto px-4 md:px-6">
                <div className="text-center">
                    <h2 className="font-headline text-3xl md:text-4xl">Our Interior Design Services in Noida</h2>
                    <p className="mt-2 text-muted-foreground max-w-2xl mx-auto">
                        Transforming spaces across Noida with thoughtful design solutions tailored to your needs.
                    </p>
                </div>
                <div 
        ...
        <section className="py-16 md:py-24">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center mb-12">
              <h2 className="font-headline text-3xl md:text-4xl">Why Choose Naims Interior in Noida?</h2>
              <p className="mt-2 text-muted-foreground max-w-2xl mx-auto">
                The preferred choice for interior design in the Noida region.
              </p>
            </div>
        ...
        <section className="py-16 md:py-24 bg-muted">
            ...
            >
                <div className="text-center mb-12">
                    ...
                    <p className="mt-2 text-lg font-semibold">Your Journey to a Dream Interior in Noida.</p>
                    <p className="mt-2 text-muted-foreground max-w-2xl mx-auto">
        ...
        <section className="bg-muted py-16 md:py-24">
            <div className="container mx-auto px-4 md:px-6">
                <div className="text-center">
                    <h2 className="font-headline text-3xl md:text-4xl">Noida Transformations: Before & After</h2>
                    <p className="mt-2 text-muted-foreground max-w-2xl mx-auto">
                        Scratch to see the transformation we bring to every space in Noida.
                    </p>
                </div>
        ...
        <section className="py-16 md:py-24">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center">
              <h2 className="font-headline text-3xl md:text-4xl">What Our Noida Clients Say</h2>
              <p className="mt-2 text-muted-foreground max-w-2xl mx-auto">We're proud to have created spaces that our Noida clients love.</p>
            </div>
             <div className="mt-12">
                <Carousel
                    plugins={plugins}
        ...
        <section className="py-16 md:py-24 bg-card">
          <div className="container mx-auto px-4 md:px-6 text-center">
            <h2 className="font-headline text-3xl md:text-4xl">
             Best Materials, Sourced for Your Noida Project
            </h2>
