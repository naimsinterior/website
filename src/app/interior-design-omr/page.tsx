...
const beforeAfterProjects = [
    {
        ...
        title: "OMR Kitchen Remodel",
        description: "From a cramped and dated kitchen to a bright, open-concept culinary hub in OMR."
    },
    {
        ...
        title: "Living Room Transformation in OMR",
...
const whyChooseUs = [
    {
        ...
        title: "Customer Satisfaction in OMR",
        description: "Our main motto is achieving customer satisfaction for our interior design projects across OMR. We love to see happy clients by delivering outstanding services.",
    },
    {
        icon: <Users className="h-8 w-8 text-primary" />,
        title: "1000+ Happy Clients in OMR",
        description: "Our 1000+ happy customers in the OMR region are a testament to our best-in-class interior designing services. We always aim to deliver high-quality service within your budget.",
    },
    {
        icon: <DollarSign className="h-8 w-8 text-primary" />,
        title: "Economic Cost for OMR Homes",
        description: "We offer an affordable wide range of interior designing services for your dream home in OMR, with no compromise on material quality to ensure durability.",
    },
     {
    ...
    },
    {
        ...
        description: "We believe that transparency is the core key in excellent customer service. So, we don't have any hidden charges. What you see is what you pay for your OMR interior project.",
    },
    {
        icon: <Briefcase className="h-8 w-8 text-primary" />,
        title: "Expert Interior Designers in OMR",
        description: "Our experienced designers have decades of experience in interior designing in OMR. Hand over everything to us and relax, we will take care of everything.",
    },
];
...
const services = [
  {
    value: "residential",
    title: "Residential Design in OMR",
    description: "We at Naims Interior, provide complete residential interior designing services in OMR including:",
    items: [
  ...
  },
  {
    ...
    title: "OMR Kitchen & Bathroom Interior",
    description: "We offer complete Kitchen and Bathroom interior services for your dream home in OMR, including:",
    items: [
  ...
  {
    value: "renovation",
    title: "Home Renovation in OMR",
    description: "We undertake complete home renovations and makeovers across the OMR area, including:",
    items: [
      "Full Home Makeover",
...
const faqs = [
    {
        question: "What is the first step to starting a project with Naims Interior in OMR?",
        answer: "The first step is to schedule a free consultation with one of our expert designers. You can do this by filling out the contact form on our website or by calling our OMR office directly. During this meeting, we'll discuss your vision, needs, and budget to see how we can best help you."
    },
    {
        question: "How long does a typical interior design project take in OMR?",
        answer: "The timeline for a project can vary greatly depending on the scope. A single room design in OMR might take 4-6 weeks, while a full home renovation could take several months. We will provide a detailed project timeline after our initial consultation and design approval."
    },
    {
        question: "Do you work with my existing furniture and decor?",
        answer: "Absolutely! We believe in creating spaces that reflect you. We can certainly incorporate your existing beloved pieces into the new design. We can also help you decide what to keep, what to reupholster, and what to replace to achieve your desired look for your OMR home."
    },
    {
        question: "What is your fee structure for projects in OMR?",
    ...
    },
     {
        ...
        answer: "Yes! We provide detailed 3D visualizations of your project. This allows you to see exactly how your space in OMR will look and feel, and gives you the opportunity to make any changes before we start the execution phase."
    },
     {
        question: "What makes Naims Interior different from other designers in OMR?",
        answer: "Our key differentiators are our deep understanding of the OMR market, a client-centric approach, commitment to quality, and transparent processes. We focus on creating personalized designs that reflect our clients' personalities and lifestyles, ensuring a seamless and enjoyable experience from start to finish."
    }
];

export default function InteriorDesignOMRPage() {
    const plugins = [
        Autoplay({
            delay: 5000,
      ...
      <main className="flex-1">
        ...
        <section className="relative h-[80vh] w-full">
          <Image
            ...
            alt="Beautifully designed living room in OMR"
            fill
            className="z-0 object-cover"
            data-ai-hint="living room OMR"
            priority
          />
          <div className="relative z-10 flex h-full flex-col items-center justify-center bg-black/50 text-center text-white">
            <h1 className="font-headline text-4xl md:text-6xl lg:text-7xl">
              Best Interior Design in OMR
            </h1>
            <p className="mt-4 max-w-2xl text-lg md:text-xl">
              Creating beautiful, functional interiors for homes and offices in OMR.
            </p>
            <div className="mt-8">
            ...
            <div className="grid gap-12 md:grid-cols-2 lg:gap-20 items-center">
              <div>
                <h2 className="font-headline text-3xl md:text-4xl">
                  Your Trusted Interior Designer in OMR
                </h2>
                <p className="mt-4 text-muted-foreground">
                  Naims Interior is a leading interior design firm in OMR, specializing in high-end residential and commercial projects. Our philosophy is to create spaces that are both functional and inspiring, reflecting the unique style of our clients in OMR.
                </p>
                <div className="mt-4">
                  <SimpleContactForm>
              ...
              <div className="relative h-80 w-full rounded-lg shadow-xl">
                 <Image
                    ...
                    alt="Design team collaborating on a OMR project"
                    fill
        ...
        <section className="bg-muted py-16 md:py-24">
            <div className="container mx-auto px-4 md:px-6">
                <div className="text-center">
                    <h2 className="font-headline text-3xl md:text-4xl">Our Interior Design Services in OMR</h2>
                    <p className="mt-2 text-muted-foreground max-w-2xl mx-auto">
                        Transforming spaces across OMR with thoughtful design solutions tailored to your needs.
                    </p>
                </div>
                <div 
        ...
        <section className="py-16 md:py-24">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center mb-12">
              <h2 className="font-headline text-3xl md:text-4xl">Why Choose Naims Interior in OMR?</h2>
              <p className="mt-2 text-muted-foreground max-w-2xl mx-auto">
                The preferred choice for interior design in the OMR region.
              </p>
            </div>
        ...
        <section className="py-16 md:py-24 bg-muted">
            ...
            >
                <div className="text-center mb-12">
                    <h2 className="font-headline text-3xl md:text-4xl">NAIMS INTERIOR PROCESS</h2>
                    <p className="mt-2 text-lg font-semibold">Your Journey to a Dream Interior in OMR.</p>
                    <p className="mt-2 text-muted-foreground max-w-2xl mx-auto">
        ...
        <section className="bg-muted py-16 md:py-24">
            <div className="container mx-auto px-4 md:px-6">
                <div className="text-center">
                    <h2 className="font-headline text-3xl md:text-4xl">OMR Transformations: Before & After</h2>
                    <p className="mt-2 text-muted-foreground max-w-2xl mx-auto">
                        Scratch to see the transformation we bring to every space in OMR.
                    </p>
                </div>
        ...
        <section className="py-16 md:py-24">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center">
              <h2 className="font-headline text-3xl md:text-4xl">What Our OMR Clients Say</h2>
              <p className="mt-2 text-muted-foreground max-w-2xl mx-auto">We're proud to have created spaces that our OMR clients love.</p>
            </div>
             <div className="mt-12">
                <Carousel
                    plugins={plugins}
        ...
        <section className="py-16 md:py-24 bg-card">
          <div className="container mx-auto px-4 md:px-6 text-center">
            <h2 className="font-headline text-3xl md:text-4xl">
             Best Materials, Sourced for Your OMR Project
            </h2>
