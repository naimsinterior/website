...
const beforeAfterProjects = [
    {
        ...
        title: "Delhi Kitchen Remodel",
        description: "From a cramped and dated kitchen to a bright, open-concept culinary hub in Delhi."
    },
    {
        ...
        title: "Living Room Transformation in Delhi",
...
const whyChooseUs = [
    {
        ...
        title: "100% Customer Satisfaction in Delhi",
        description: "Our main motto is achieving 100% customer satisfaction for our interior design projects across Delhi. We love to see happy clients by delivering outstanding services.",
    },
    {
        icon: <Users className="h-8 w-8 text-primary" />,
        title: "1000+ Happy Clients in Delhi",
        description: "Our 1000+ happy customers in the Delhi region are a testament to our best-in-class interior designing services. We always aim to deliver high-quality service within your budget.",
    },
    {
        icon: <DollarSign className="h-8 w-8 text-primary" />,
        title: "Economic Cost for Delhi Homes",
        description: "We offer an affordable wide range of interior designing services for your dream home in Delhi, with no compromise on material quality to ensure durability.",
    },
     {
    ...
    },
    {
        ...
        description: "We believe that transparency is the core key in excellent customer service. So, we don't have any hidden charges. What you see is what you pay for your Delhi interior project.",
    },
    {
        icon: <Briefcase className="h-8 w-8 text-primary" />,
        title: "Expert Interior Designers in Delhi",
        description: "Our experienced designers have decades of experience in interior designing in Delhi. Hand over everything to us and relax, we will take care of everything.",
    },
];
...
const services = [
  {
    value: "residential",
    title: "Residential Design in Delhi",
    description: "We at Naims Interior, provide complete residential interior designing services in Delhi including:",
    items: [
  ...
  },
  {
    ...
    title: "Delhi Kitchen & Bathroom Interior",
    description: "We offer complete Kitchen and Bathroom interior services for your dream home in Delhi, including:",
    items: [
  ...
  {
    value: "renovation",
    title: "Home Renovation in Delhi",
    description: "We undertake complete home renovations and makeovers across the Delhi area, including:",
    items: [
      "Full Home Makeover",
...
const faqs = [
    ...
    },
    {
     ...
     {
        question: "What makes Naims Interior different from other designers in Delhi?",
        answer: "Our key differentiators are our deep understanding of the Delhi market, a client-centric approach, commitment to quality, and transparent processes. We focus on creating personalized designs that reflect our clients' personalities and lifestyles, ensuring a seamless and enjoyable experience from start to finish."
    }
];

export default function InteriorDesignDelhiPage() {
    const plugins = [
        Autoplay({
            delay: 5000,
      ...
      <main className="flex-1">
        ...
        <section className="relative h-[80vh] w-full">
          <Image
            ...
            alt="Beautifully designed living room in Delhi"
            fill
            className="z-0 object-cover"
            data-ai-hint="living room Delhi"
            priority
          />
          <div className="relative z-10 flex h-full flex-col items-center justify-center bg-black/50 text-center text-white">
            <h1 className="font-headline text-4xl md:text-6xl lg:text-7xl">
              Best Interior Design in Delhi
            </h1>
            <p className="mt-4 max-w-2xl text-lg md:text-xl">
              Creating beautiful, functional interiors for homes and offices in Delhi.
            </p>
            <div className="mt-8">
            ...
            <div className="grid gap-12 md:grid-cols-2 lg:gap-20 items-center">
              <div>
                <h2 className="font-headline text-3xl md:text-4xl">
                  Your Trusted Interior Designer in Delhi
                </h2>
                <p className="mt-4 text-muted-foreground">
                  Naims Interior is a leading interior design firm in Delhi, specializing in high-end residential and commercial projects. Our philosophy is to create spaces that are both functional and inspiring, reflecting the unique style of our clients in Delhi.
                </p>
              ...
              <div className="relative h-80 w-full rounded-lg shadow-xl">
                 <Image
                    ...
                    alt="Design team collaborating on a Delhi project"
                    fill
        ...
        <section className="bg-muted py-16 md:py-24">
            <div className="container mx-auto px-4 md:px-6">
                <div className="text-center">
                    <h2 className="font-headline text-3xl md:text-4xl">Our Interior Design Services in Delhi</h2>
                    <p className="mt-2 text-muted-foreground max-w-2xl mx-auto">
                        Transforming spaces across Delhi with thoughtful design solutions tailored to your needs.
                    </p>
                </div>
                <div 
        ...
        <section className="py-16 md:py-24">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center mb-12">
              <h2 className="font-headline text-3xl md:text-4xl">Why Choose Naims Interior in Delhi?</h2>
              <p className="mt-2 text-muted-foreground max-w-2xl mx-auto">
                The preferred choice for interior design in the Delhi region.
              </p>
            </div>
        ...
        <section className="py-16 md:py-24 bg-muted">
            ...
            >
                <div className="text-center mb-12">
                    ...
                    <p className="mt-2 text-lg font-semibold">Your Journey to a Dream Interior in Delhi.</p>
                    <p className="mt-2 text-muted-foreground max-w-2xl mx-auto">
        ...
        <section className="bg-muted py-16 md:py-24">
            <div className="container mx-auto px-4 md:px-6">
                <div className="text-center">
                    <h2 className="font-headline text-3xl md:text-4xl">Delhi Transformations: Before & After</h2>
                    <p className="mt-2 text-muted-foreground max-w-2xl mx-auto">
                        Scratch to see the transformation we bring to every space in Delhi.
                    </p>
                </div>
        ...
        <section className="py-16 md:py-24">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center">
              <h2 className="font-headline text-3xl md:text-4xl">What Our Delhi Clients Say</h2>
              <p className="mt-2 text-muted-foreground max-w-2xl mx-auto">We're proud to have created spaces that our Delhi clients love.</p>
            </div>
             <div className="mt-12">
                <Carousel
                    plugins={plugins}
